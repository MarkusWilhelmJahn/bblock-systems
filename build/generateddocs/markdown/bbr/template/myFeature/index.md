...
```jsonld
{
  "@context": [
    ...
    "https://markuswilhelmjahn.github.io/bblock-systems/build/annotated/bbr/template/myFeature/context.jsonld",
    {
      "mynamespace": "http://example.org/ns1/"
    }
  ],
...
$defs:
  MyFeature:
    ...
    - properties:
        properties:
          $ref: https://markuswilhelmjahn.github.io/bblock-systems/build/annotated/bbr/template/mySchema/schema.yaml
anyOf:
- $ref: '#/$defs/MyFeature'
...
* YAML version: [schema.yaml](https://markuswilhelmjahn.github.io/bblock-systems/build/annotated/bbr/template/myFeature/schema.json)
* JSON version: [schema.json](https://markuswilhelmjahn.github.io/bblock-systems/build/annotated/bbr/template/myFeature/schema.yaml)
...
[context.jsonld](https://markuswilhelmjahn.github.io/bblock-systems/build/annotated/bbr/template/myFeature/context.jsonld)
